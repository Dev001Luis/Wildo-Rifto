    ...
    <div class="row justify-content-center ">
        <div class="col-12 col-lg-6">
            <div class="card mx-3">
                ...
                <p class="card-text">Passive : {{$character['passive']}}.</p>
                <br>
                <p class="card-text">Q : {{$character['q']}}.</p>
                <br>
                <p class="card-text">w : {{$character['w']}}.</p>
                <br>
                <p class="card-text">E : {{$character['e']}}.</p>
                <br>
                <p class="card-text">R : {{$character['r']}}.</p>
                </div>
                <a href="{{route('all-Characters')}}" class="btn card-btn bg-dark text-white">Torna indietro</a>
            </div>
        </div>
    </div>
</div>
